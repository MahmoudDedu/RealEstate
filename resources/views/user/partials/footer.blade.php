            ...
            <div class="row">
                        ...
                        <ul class="footer-blog">
                            <li>
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-8 blg-entry">
                                    <h6><a href="single.html">New Property Listings</a></h6>
                                    <p>Check out our latest properties available this month!</p>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-md-3 col-sm-6 wow fadeInRight animated">
                    <div class="single-footer news-letter">
                        <h4>Stay in touch</h4>
                        <div class="footer-title-line"></div>
                        <p>Subscribe to our newsletter to stay updated with our latest offers.</p>
                        <form>
